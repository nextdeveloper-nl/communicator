...
namespace NextDeveloper\communicator;
 ...
 *
 * @package NextDeveloper\communicator
 */
class communicatorServiceProvider extends AbstractServiceProvider {
    /**
     * @var bool
     */
    ...
    public function boot() {
        ...
        $this->loadViewsFrom($this->dir.'/../resources/views', 'communicator');
...
//    }
    ...
    protected function registerRoutes() {
        if ( ! $this->app->routesAreCached()) {
            $this->app['router']
                ->namespace('NextDeveloper\communicator\Http\Controllers')
